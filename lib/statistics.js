...
class statistics {
	...
	async _calculateGeneric2(stateId, periodStart) {
		const stats = [
			...
			{
				sourceId: 'sun2000.0.collected.SOC',
				targetPath: 'SOC',
				unit: '%',
				type: statisticsType.level, // value is a level that can go up and down, so we take the value as is without calculating delta
			},
			{ sourceId: 'sun2000.0.collected.gridExportToday', targetPath: 'gridExportToday', unit: 'kWh', type: statisticsType.delta },
			{ sourceId: 'sun2000.0.collected.gridImportToday', targetPath: 'gridImportToday', unit: 'kWh', type: statisticsType.delta },
		];

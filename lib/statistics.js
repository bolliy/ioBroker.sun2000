	...
	_buildFlexchart2(myChart) {
		...
		*/
		...
		const chart = {
			...
			xAxis: [
				{
					// Hauptachse — nur Uhrzeit anzeigen
					type: 'category',
					data: xAxisData,
					scale: true,
					boundaryGap: false,
					...
					axisLabel: {
						formatter:
							myChart === 'hourly'
								? value => value.split(' ')[1] // nur Uhrzeit aus "14.03.2025 08:00"
								: null, // andere Charts unverändert
					},
				},
				{
					// Untere Achse (Consumption-Panel) — Label ausgeblendet, Slider nutzt xAxisData direkt
					type: 'category',
					gridIndex: 1,
					data: xAxisData,
					scale: true,

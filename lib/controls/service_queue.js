...
class ServiceQueueMap {
	...
	/**
	 * Validates whether the event's value is a number.
	 * Logs a warning if the value is not a number.
	 *
	 * @param {object} event - The event object containing the value to be tested.
	 * @param {boolean} round

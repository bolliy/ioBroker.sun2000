		...
		this.inverterPostProcessHooks = [
			{
				...
				states: [
					...
					{ id: 'collected.feedinPower', name: 'Feed-in power', type: 'number', unit: 'kW', role: 'value.power', desc: 'Power to grid' },
				...
				fn: inverters => {
					...
					this.stateCache.set('collected.feedinPower', feedinPower, { type: 'number', renew: true }); //positive -> power to grid

		...
		this.postUpdateHooks = [
			{
				...
				fn : (path) => {
					...
					const energyLoss = new Date().getHours()*this.inverterInfo.energyLoss; //+disCharge*0.1;
		...
		this.postProcessHooks = [
			...
			},
			{
				...
				states : [
					...
					{id: 'collected.dailyInputYield', name: 'Portal Yield Today', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'Try to recreate the yield from the portal'},

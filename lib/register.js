	...
	constructor(adapterInstance) {
		...
		this.registerFields = [
			...
			},
			{
				...
				states: [
					{
						state: {id: 'battery.unit.1.runningStatus', name: 'running status', type: 'number', unit: '', role: 'value'},
						register: {reg: 37000, type: dataType.uint16}
					},
					{
						state: {id: 'battery.unit.1.batterySOC', name: 'battery SOC', type: 'number', unit: '%', role: 'value'},
			...
			},
			{
				...
				states: [
					{
						state: {id: 'battery.unit.2.runningStatus', name: 'running status', type: 'number', unit: '', role: 'value'},
						register: {reg: 37741, type: dataType.uint16}
					},
					{
						state: {id: 'battery.unit.2.batterySOC', name: 'battery SOC', type: 'number', unit: '%', role: 'value'},

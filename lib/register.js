		...
		this.postUpdateHooks = [
			{
				...
				fn : (path) => {
					...
					/*
					const now = new Date();
					const sunset  = this.adapter.getAstroDate('sunset', this.adapter.getDateObject(now.getTime()));   //Sonnenuntergang
					const sunrise = this.adapter.getAstroDate('sunrise', this.adapter.getDateObject(now.getTime()));  //Sonnenaufgang
                    */

		...
		this.postProcessHooks = [
			...
			},
			{
				...
				fn: inverters => {
					...
					if (conSum < 0 || Number.isNaN(conSum)) {
						this.adapter.log.warn(
							`Invalid consumption sum: ${conSum}, activeEnergy ${activeEnergy} enYield ${enYield} supplyFromGrid ${supplyFromGrid} feedinEnergy ${feedinEnergy}`,
						);
					} else {

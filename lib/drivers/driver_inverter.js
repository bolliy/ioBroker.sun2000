		...
		const newFields = [
			...
			},
			{
				...
				},
				{
					...
					register: {reg: 47416, type: dataType.uint32}
				},
				{
					state: { id: 'grid.maximumFeedGridPower_percent', name: 'Maximum Feed Grid Power %', type: 'number', unit: '%', role: 'value', desc: 'reg: 47418, len: 2'},
					register: {reg: 47418, type: dataType.int16}
				}
				]
			}

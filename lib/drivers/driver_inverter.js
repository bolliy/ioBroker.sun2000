...
class InverterSun2000 extends DriverBase {
	constructor(stateInstance, inverter, options) {
		...
		this.stateCache.set(`meter.derived.directionOfPowerFlow`, 0, { type: 'number' });
			...
			*/
			...
			},
			{
				...
				states: [
					...
					{
						state: {
							id: 'meter.derived.directionOfPowerFlow',
							name: 'direction of power flow',
							type: 'number',
							unit: '',
							role: 'value',
							desc: '0=positive value means power flow to grid, 1=positive value means power flow from grid',
						},
					},
					{
						state: {

			...
			},
			{
				...
				postHook: path => {
					...
					if (currentDayChargeCapacity > this.chargeSumHelper.sum) {
						...
						this.adapter.log.warn(`Set charge sum helper to current day charge capacity from inverter: ${currentDayChargeCapacity} kWh`);
					}
					...
					if (currentDayDischargeCapacity > this.dischargeSumHelper.sum) {
						...
						this.adapter.log.warn(`Set discharge sum helper to current day discharge capacity from inverter: ${currentDayDischargeCapacity} kWh`);
					}

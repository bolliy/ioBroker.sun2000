		...
		const newFields = [
			...
			},
			{
				...
				postHook: path => {
					...
					const currentDayChargeCapacity = this.stateCache.get(`${path}battery.statistics.currentDayChargeCapacity`)?.value;
					if (currentDayChargeCapacity !== undefined && currentDayChargeCapacity - this.chargeSumHelper.sum > 0.09) {
						this.chargeSumHelper.setStart(currentDayChargeCapacity);
					}

					const currentDayDischargeCapacity = this.stateCache.get(`${path}battery.statistics.currentDayDischargeCapacity`)?.value;
					if (currentDayDischargeCapacity !== undefined && currentDayDischargeCapacity - this.dischargeSumHelper.sum > 0.09) {

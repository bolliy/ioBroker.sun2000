		...
		const newFields = [
			{
				...
				/**
				 * PostHook after reading the registers.
				 * @callback
				 * @async
				 * @description
				 * In TestMode, this hook is used to identify the subdevices (Emma Chargers) and store them in this.adapter.devices.
				 * The function calls {@link InverterSun2000#identifySubdevices} and pushes the results into this.adapter.devices.
				 * The hook is called after the registers have been read.
				 */
				postHook: () => {

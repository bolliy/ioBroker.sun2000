		...
		const newFields = [
			...
			},
			{
				...
				postHook: path => {
					...
					if (currentDayChargeCapacity !== undefined && !this.chargeSumHelper.startInitialized) {
					...
					if (currentDayDischargeCapacity !== undefined && !this.dischargeSumHelper.startInitialized) {

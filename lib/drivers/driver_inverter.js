...
class InverterSun2000 extends DriverBase{
		...
		const newFields = [
			...
			},
			{
				...
				states : [{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32080')),
			...
			},
			{
				...
				states : [{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37765')),
				}]
			},
			{
				address : 32064,
				...
				states : [{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32064')),
					store : storeType.always
				},
				{
			...
			},
			{
				...
				states: [{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37113')),
				}]
			},
			{
				address : 37052,
				...
				states: [
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32066'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32067'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32068'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32069'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32070'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32071'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32072'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,0,'32074'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,0,'32076'))
					},
					{
					...
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32082'))
					},
					{
			...
			},
			{
				...
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37101'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37103'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37105'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37107'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37109'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37111'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,0,'37115'))
				},
				{
				...
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37126'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37128'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37130'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,0,'37132'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,0,'37134'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e6,1e6,'37136'))
				}
				]
			},
			{
				...
				states: [
					...
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37763'))
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'37764'))
					},
					{
			...
			states : [
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32016'))
				},
				{
					...
					mapper: value => Promise.resolve(this._checkValidNumber(value,-1e3,1e3,0,'32017'))
				},
				{
	...
	_checkValidNumber( value, from = 0, until = 100, substWith = 0, id = '') {
		if (typeof value == 'number') {
			if (value >= from && value <= until) {
				return value;
			}
			this.log.error('_checkValidNumber '+value+' from: '+from+' until: '+until+' id '+id);
			return substWith;
		}
		return value;
	}
			...
			},
			{
				...
				states: [
					...
					},
					{
						...
						mapper: value => Promise.resolve(this._checkValidNumber(value,-100,100,0,'37752'))
					}
				]
			},
			{   //for NRGKick

		...
		const newFields = [
			...
			},
			{
				...
				postHook: path => {
					...
					this.chargeSumHelper.add(chargeDischargePower > 0 ? chargeDischargePower : 0); //riemann Sum for charge power
					this.dischargeSumHelper.add(chargeDischargePower < 0 ? -chargeDischargePower : 0); //riemann Sum for discharge power

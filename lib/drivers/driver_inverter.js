		...
		const newFields = [
			...
			},
			{
				...
				postHook: path => {
					...
					this.stateCache.set(`${path}battery.statistics.currentDayChargeEnergy`, this.chargeSumHelper.sum, { type: 'number' });
					this.stateCache.set(`${path}battery.statistics.currentDayDischargeEnergy`, this.dischargeSumHelper.sum, { type: 'number' });
				},
			},
			{
				address: 32064,

	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			},
			{
				address : 38229,
				length : 13,
				info : 'battery further information',
				refresh : dataRefreshRate.low,
				type : deviceType.battery,
				states: [
					{
						state: {id: 'battery.unit.1.batteryPack.1.SOC', name: 'State of capacity', type: 'number', unit: '%', role: 'value.battery', desc: 'reg:38355, len:1'},
						register: {reg: 38229, type: dataType.uint16, gain: 10}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.1.totalCharge', name: 'Total Charge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38364, len:2'},
						register: {reg: 38238, type: dataType.uint32, gain: 100}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.1.totalDischarge', name: 'Total Discharge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38366, len:2'},
			...
			},
			{
				...
				states: [
					{
						state: {id: 'battery.unit.1.batteryPack.2.SOC', name: 'State of capacity', type: 'number', unit: '%', role: 'value.battery', desc: 'reg:38397, len:1'},
						register: {reg: 38271, type: dataType.uint16, gain: 10}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.2.totalCharge', name: 'Total Charge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38406, len:2'},
						register: {reg: 38280, type: dataType.uint32, gain: 100}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.2.totalDischarge', name: 'Total Discharge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38408, len:2'},
			...
			},
			{
				...
				states: [
					{
						state: {id: 'battery.unit.1.batteryPack.3.SOC', name: 'State of capacity', type: 'number', unit: '%', role: 'value.battery', desc: 'reg:38397, len:1'},
						register: {reg: 38313, type: dataType.uint16, gain: 10}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.3.totalCharge', name: 'Total Charge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38406, len:2'},
						register: {reg: 38322, type: dataType.uint32, gain: 100}
					},
					{
						state: {id: 'battery.unit.1.batteryPack.3.totalDischarge', name: 'Total Discharge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38408, len:2'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.1.batteryPack.1.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
					register: {reg: 38233, type: dataType.int32, gain:1000}
				},
				{
					state: {id: 'battery.unit.1.batteryPack.1.voltage', name: 'Voltage', type: 'number', unit: 'V', role: 'value.voltage', desc: 'reg:38361, len:1'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.1.batteryPack.2.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
					register: {reg: 38275, type: dataType.int32, gain:1000}
				},
				{
					state: {id: 'battery.unit.1.batteryPack.2.voltage', name: 'Voltage', type: 'number', unit: 'V', role: 'value.voltage', desc: 'reg:38403, len:1'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.1.batteryPack.3.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
					register: {reg: 38317, type: dataType.int32, gain:1000}
				},
				{
					state: {id: 'battery.unit.1.batteryPack.3.voltage', name: 'Voltage', type: 'number', unit: 'V', role: 'value.voltage', desc: 'reg:38403, len:1'},
	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			},
			{
				...
				states: [
					{
						state: {id: 'battery.unit.2.batteryPack.3.SOC', name: 'State of capacity', type: 'number', unit: '%', role: 'value.battery', desc: 'reg:38397, len:1'},
						register: {reg: 38439, type: dataType.uint16, gain: 10}
					},
					{
						state: {id: 'battery.unit.2.batteryPack.3.totalCharge', name: 'Total Charge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38406, len:2'},
						register: {reg: 38448, type: dataType.uint32, gain: 100}
					},
					{
						state: {id: 'battery.unit.2.batteryPack.3.totalDischarge', name: 'Total Discharge', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:38408, len:2'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.2.batteryPack.1.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.2.batteryPack.2.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
			...
			},
			{
				...
				type : deviceType.battery,
				states : [{
					state: {id: 'battery.unit.2.batteryPack.3.chargeDischargePower', name: 'Charge/Discharge power', desc: '(>0 charging, <0 discharging)', type: 'number', unit: 'kW', role: 'value.power'},
					register: {reg: 38443, type: dataType.int32, gain:1000}
				},
				{
					state: {id: 'battery.unit.2.batteryPack.3.voltage', name: 'Voltage', type: 'number', unit: 'V', role: 'value.voltage', desc: 'reg:38403, len:1'},

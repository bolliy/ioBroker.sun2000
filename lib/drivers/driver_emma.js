		...
		const newFields = [
			...
			*/
			...
			},
			{
				...
				states: [{
					state: {id: 'emma.numberOfInverters', name: 'Number of inverters found', type: 'number', unit: '', role: 'value', desc: 'reg:30801, len:1'},
					register: {reg: 30801, type: dataType.uint16}
				},
				{
					state: {id: 'emma.numberOfCharger', name: 'Number of chargers found', type: 'number', unit: '', role: 'value', desc: 'reg:30804, len:1'},
			...
			},
			{
				...
				states: [
					...
					{
						state: {id: 'meter.activePower', name: 'ActivePower', type: 'number', unit: 'kW', role: 'value.power.active', desc: 'reg:31657, len:2 (>0: feed-in to grid. <0: supply from grid.)' },
					...
					{
						state: {id: 'meter.voltageL2-L3', name: 'Voltage L2-L3', type: 'number', unit: 'V', role: 'value.voltage', desc: 'reg:31647  , len:2'},
					...
					{
						state: {id: 'meter.activePowerL1', name: 'Active Power L1', type: 'number', unit: 'kW', role: 'value.power', desc: 'reg:31651, len:2'},
						register: {reg: 31651, type: dataType.int32, gain: 1000}
					},
					{
						state: {id: 'meter.activePowerL2', name: 'Active Power L2', type: 'number', unit: 'kW', role: 'value.power', desc: 'reg:31653, len:2'},
						register: {reg: 31653, type: dataType.int32, gain: 1000}
					},
					{
						state: {id: 'meter.activePowerL3', name: 'Active Power L3', type: 'number', unit: 'kW', role: 'value.power', desc: 'reg:31655, len:2'},
						register: {reg: 31655, type: dataType.int32, gain: 1000}
					},
					{
						state: {id: 'meter.reverseActiveEnergy', name: 'Reverse Active Energy', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:31679, len:4'},
						register: {reg: 31679, type: dataType.int64, gain: 100}
					},
					{
						state: {id: 'meter.positiveActiveEnergy', name: 'Positive Active Energy', type: 'number', unit: 'kWh', role: 'value.power.consumption', desc: 'reg:31687, len:4'},

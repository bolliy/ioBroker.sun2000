...
class DriverBase {
	...
	getHoldingRegisters(startAddr, length) {
		return this._regMap.get(startAddr,length);
	}
	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			{   //for NRGKick
				...
				states: [
					{
						state: { id: 'battery.unit.1.productMode', name: 'Product Mode', type: 'integer', unit: '', role: 'value'},
	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			{   //for NRGKick
				...
				states: [
					{
						state: { id: 'battery.unit.2.productMode', name: 'Product Mode', type: 'integer', unit: '', role: 'value'},

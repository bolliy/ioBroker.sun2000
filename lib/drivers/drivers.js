	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			{   //for NRGKick
				...
				states: [
					{
						state: { id: 'battery.unit.1.productMode', name: 'Product Mode', type: 'number', unit: '', role: 'value'},
	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			{   //for NRGKick
				...
				states: [
					{
						state: { id: 'battery.unit.2.productMode', name: 'Product Mode', type: 'number', unit: '', role: 'value'},

	...
	constructor(stateInstance,inverter,options) {
		...
		const newFields = [
			...
			},
			{
				...
				refresh : dataRefreshRate.low,
				states: [{
					state: {id: 'slogger.runningInverters', name: 'Quantity of running PV inverters', type: 'number', unit: '', role: 'value', desc: 'reg:40206, len:1'},
					register: {reg: 40206, type: dataType.uint16}
				},
				{
					state: {id: 'slogger.runningESSPCSs', name: 'Quantity of running ESS PCSs', type: 'number', unit: 'V', role: 'value', desc: 'reg:40207, len:1'},
